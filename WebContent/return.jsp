...
<body>
	...
	<div id="bookingForm" style="width:100%; height:auto; padding:1%;">
		<fieldset>
			<legend>Return Inventory form</legend>
			<font color=red size=4 face="arial" style="margin-bottom: 1%;margin-top: 1%;">${MSG}</font>
			<form action="return.jlc" method="post" name="myForm">
				...
				<input type="submit" style="width:21.5%; height:35px; padding:0.5%; margin:1%;" value="Return"/>
			</form>
		</fieldset>
	</div>
	</center>
